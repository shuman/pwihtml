...
SHIP_TEXTURE = new Image();
SHIP_TEXTURE.src = 'gamesource/game1/newship.png';

ALIEN_TEXTURE = new Image();
ALIEN_TEXTURE.src = 'gamesource/game1/alien.png';
...
Sprite = function () {
    this.init = function (name, points, custom) {
        this.name = name;
        this.points = points;
        this.custom = typeof custom !== 'undefined' ? custom : {};
    ...
    this.draw = function () {
        ...
        // Fill Sprite
        if (typeof this.custom.fill !== 'undefined') {
            this.context.fillStyle = this.custom.fill;
            this.context.fill();
        }
        // Border Style
        if (typeof this.custom.border !== 'undefined') {
            this.context.strokeStyle = this.custom.border;
        }
        // Ship style
        if (typeof this.custom.spaceship !== 'undefined') {
            this.context.drawImage(this.custom.spaceship, -15, -17, 30, 30);
        }
        // Alien style
        if (typeof this.custom.alien !== 'undefined') {
            this.context.drawImage(this.custom.alien, -28, -11, 55, 18);
        }
        // Stroke or not
        if (typeof this.custom.noStroke === 'undefined') {
            this.context.stroke();
        }
    };
...
Ship = function () {
    ...
    this.children.exhaust.init("exhaust",
                             [-3, 9,
                               ...
                               3, 9],
                              {
                                  fill: FLAME_COLORS.background,
                                  border: FLAME_COLORS.border
                              });
...
Bullet = function () {
    ...
    this.draw = function () {
        if (this.visible) {
            ...
            this.context.moveTo(this.x + 1, this.y - 1);
            this.context.lineTo(this.x - 1, this.y + 1);
            this.context.strokeStyle = BULLET_COLORS.border;
            this.context.stroke();
            this.context.restore();
        }
    };
...
AlienBullet = function () {
    ...
    this.draw = function () {
        if (this.visible) {
            ...
            this.context.strokeStyle = ALIEN_BULLET_COLORS.border;
            this.context.stroke();
            this.context.restore();
        }
    };
...
Asteroid = function () {
    this.init("asteroid",
            [-10, 0,
              ...
              -4, -5],
            {
                fill: ASTEROID_COLORS.background,
                border: ASTEROID_COLORS.border
            });
...
Explosion = function () {
    ...
    this.draw = function () {
        if (this.visible) {
            ...
            this.context.strokeStyle = EXPLOSION_COLORS.border;
            this.context.stroke();
            this.context.restore();
        }
    };
...
Text = {
    ...
    renderText: function (text, size, x, y) {
        ...
        this.context.fillStyle = TEXT_COLORS.background;
        this.context.fill();
...
SFX = {
    laser: new Audio('gamesource/game1/39459__THE_bizniss__laser.wav'),
    explosion: new Audio('gamesource/game1/51467__smcameron__missile_explosion.wav')
};
